...
exports.swig = function swig(views, options) {
    var rendered;
    ...
    Object.keys(views).forEach(function(view) {
        views[view] = swigModule.compileFile(views[view]);
    });
    ...
    return function(files, metalsmith, cb) {
        ...
        Object.keys(files).forEach(function(filename) {
            ...
            rendered = views[file.template](context);
...
// Add information about JSDoc tags to the files object.
exports.addJsdocTags = function addJsdocTags() {
    return function(files, metalsmith, cb) {
        var file;
        ...
        function addTag(tag, filename, isSynonym) {
            metadata.tags[tag] = {
                filename: filename,
                isSynonym: !!isSynonym
            };
...
// Add data for building the index.html file.
exports.addIndexData = function addIndexData() {
    return function(files, metalsmith, cb) {
        var metadata = metalsmith.metadata();

        metadata.tocData = require('../data/toc-data.json');
